...
HD_PWD='F:/2019011211011HangjenChan/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log proj_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source proj_1.tcl
