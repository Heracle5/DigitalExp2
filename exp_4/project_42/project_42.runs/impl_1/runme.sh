...
HD_PWD='F:/2019011211011/project_42/project_42.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dyna_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dyna_test.tcl -notrace
