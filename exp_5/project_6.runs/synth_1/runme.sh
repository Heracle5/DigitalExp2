...
HD_PWD='F:/2019011211011HangjenChan/project_6/project_6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log key_deboucing.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source key_deboucing.tcl
