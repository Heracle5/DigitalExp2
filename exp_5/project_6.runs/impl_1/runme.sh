...
HD_PWD='F:/2019011211011HangjenChan/project_6/project_6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log key_deboucing.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source key_deboucing.tcl -notrace
