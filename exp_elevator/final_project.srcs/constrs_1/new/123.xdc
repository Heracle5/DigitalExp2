...
set_property PACKAGE_PIN E3 [get_ports {shinyled[4]}]
set_property PACKAGE_PIN H3 [get_ports {shinyled[3]}]
set_property PACKAGE_PIN G5 [get_ports {shinyled[2]}]
set_property PACKAGE_PIN R1 [get_ports {shinyled[1]}]
set_property PACKAGE_PIN T2 [get_ports {shinyled[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {shinyled[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {shinyled[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {shinyled[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {shinyled[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {shinyled[0]}]
