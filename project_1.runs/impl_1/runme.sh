...
HD_PWD='F:/2019011211011HangjenChan/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log proj_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source proj_1.tcl -notrace
