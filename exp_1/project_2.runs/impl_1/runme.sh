...
HD_PWD='F:/2019011211011HangjenChan/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log encoder_83.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source encoder_83.tcl -notrace
