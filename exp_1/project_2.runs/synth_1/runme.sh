...
HD_PWD='F:/2019011211011HangjenChan/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log encoder_83.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source encoder_83.tcl
