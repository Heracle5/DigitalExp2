...
HD_PWD='F:/2019011211011HangjenChan/project_3/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log digitaltube.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source digitaltube.tcl -notrace
