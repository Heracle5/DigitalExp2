...
HD_PWD='F:/2019011211011HangjenChan/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log digitaltube.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source digitaltube.tcl
